...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আমাকে ডেকো না জান আমার পবিএ পাপী চুম্মা খোর বস এর মন ভালো নেই তাই আমরা ও মন ভালো নেই😭😅",
          "আমাকে আবার ডাকলে আমি কিন্তু কিস করে দিবো",
          "বার বার আমাকে ডাকস কেন দেকস না আমি আমার বস পবিএ পাপী চুম্মা খোর জানুর সাথে বিজি😡",
          "আমাকে না ডেকে বস পবিএ পাপী চুম্মা খোর কে একটা উম্মাহ দে🥱",
          "মেয়ে হলে বস পবিএ পাপী চুম্মা খোর এর ইনবক্সে চলে জাও 😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে বস পবিএ পাপী চুম্মা খোর কে একটা জিএফ দে 🙄",
          "বার বার ডাকস কেন শুনছি তো",
          "জান আসো জামাই বোউ খেলি🙈😻"
        ];
